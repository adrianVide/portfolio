...
class Sticky extends Component {
  ...
  handleScroll = () => {
    ...
    if (typeof sides.bottom === 'number') {
      const stuckBottom =
        stickyRect.y + stickyRect.height > scrollRect.height + scrollRect.top - sides.bottom;
    ...
    if (typeof sides.right === 'number') {
      const stuckRight =
        stickyRect.x + stickyRect.width > scrollRect.width + scrollRect.left - sides.right;
  ...
  render() {
    ...
    return (
      <div className={Sticky.baseClass} ref={this.stickyDiv}>
